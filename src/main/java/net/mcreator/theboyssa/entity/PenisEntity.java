...
package net.mcreator.theboyssa.entity;
...
import net.mcreator.theboyssa.procedures.MilkingProcedure;
...
public class PenisEntity extends PathfinderMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("bamboo_jungle"),
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TheboyssaModItems.CUMDROP));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MilkingProcedure.execute(sourceentity);
		return retval;
	}
