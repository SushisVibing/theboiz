...
import net.mcreator.theboyssa.client.particle.CumpaticleParticle;
...
public class TheboyssaModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType CUMPATICLE = register(new SimpleParticleType(false).setRegistryName("cumpaticle"),
			CumpaticleParticle::provider);
