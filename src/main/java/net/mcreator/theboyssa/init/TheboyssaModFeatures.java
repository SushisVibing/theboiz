...
import net.mcreator.theboyssa.world.features.lakes.CumfluidFeature;
...
public class TheboyssaModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(CumfluidFeature.FEATURE,
				new FeatureRegistration(GenerationStep.Decoration.LAKES, CumfluidFeature.GENERATE_BIOMES, CumfluidFeature.CONFIGURED_FEATURE));
	}
